...
class FaceRecognition:
    ...
    def faceDetect(self, Entry1,):
        ...
        while (True):
            ...
            for (x, y, w, h) in faces:
                ...
                cv.imwrite(BASE_DIR+'/Face_Detection/dataset/User.' +
    ...
    def trainFace(self):
        ...
        recognizer.save(BASE_DIR+'/Face_Detection/trainer/trainer.yml')
    ...
    def recognizeFace(self):
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                cv.putText(img, str(name), (x+5, y-5),
                           font, 1, (255, 255, 255), 2)
                cv.putText(img, str(confidence), (x+5, y+h-5),
                           font, 1, (255, 255, 0), 1)
